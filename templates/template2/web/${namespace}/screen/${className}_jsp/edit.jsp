...
<rapid:override name="content_header">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><%=${className}.TABLE_ALIAS%>编辑</li>
      </ol>
    </section>
</rapid:override>
...
<rapid:override name="content">
	...
	<form id="query_form" name="query_form" action="<@jspEl 'ctx'/>/${namespace }/${className }/update.do" method="post" class="form-horizontal">
