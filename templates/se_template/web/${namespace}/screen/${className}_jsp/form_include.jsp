...
<div class="form-group col-sm-4">
  ...
  <div class="col-sm-7">
  	<#if column.isDateTimeColumn>
		<input value="<@jspEl 'model.'+column.columnNameLower+'String'/>" id="${column.columnNameLower}String" name="${column.columnNameLower}" class="form-control Wdate" readonly="readonly" onClick="WdatePicker({dateFmt:'<%=${className}.FORMAT_${column.constantName}%>'})" />
	<#else>
